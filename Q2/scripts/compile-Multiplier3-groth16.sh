...
snarkjs groth16 setup Multiplier3/Multiplier3.r1cs powersOfTau28_hez_final_10.ptau Multiplier3/groth16/circuit_0000.zkey
...
snarkjs zkey export solidityverifier Multiplier3/groth16/circuit_final.zkey ../HelloWorldVerifier-groth16.sol
